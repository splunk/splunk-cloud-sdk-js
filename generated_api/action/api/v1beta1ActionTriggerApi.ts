...
export enum V1beta1ActionTriggerApiApiKeys {
}

export class V1beta1ActionTriggerApi {
    ...
    public setApiKey(key: V1beta1ActionTriggerApiApiKeys, value: string) {
        (this.authentications as any)[V1beta1ActionTriggerApiApiKeys[key]].apiKey = value;
    }
