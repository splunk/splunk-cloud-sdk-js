...
export abstract class CatalogServiceGen extends BaseApiService {
     ...
     * @param args.filter A filter query to apply to the rule.
     * @return Array<Action>
     */
    public listActionsForRule = (ruleresourcename: string, args?: { filter?: string }): Promise<Array<Action>> => {
        const path_params = {
            ruleresourcename: ruleresourcename
        };
        const path = this.template`/catalog/v2beta1/rules/${'ruleresourcename'}/actions`(path_params);
     ...
     * @param ruleid ID of a Field.
     * @param args All other arguments.
     * @param args.filter A filter query to apply to the actions.
     * @return Array<Action>
     */
    public listActionsForRuleById = (ruleid: string, args?: { filter?: string }): Promise<Array<Action>> => {
        const path_params = {
            ruleid: ruleid
        };
        const path = this.template`/catalog/v2beta1/rules/${'ruleid'}/actions`(path_params);
     ...
     */
    public listDashboards = (): Promise<Array<Dashboard>> => {
        const path = `/catalog/v2beta1/dashboards`;
        return this.client.get(CATALOG_SERVICE_CLUSTER, this.client.buildPath('', path.split('/').slice(1)))
     ...
     * @param args All other arguments.
     * @param args.filter A filter query to apply to the the field list.
     * @return Array<Field>
     */
    public listFields = (args?: { filter?: string }): Promise<Array<Field>> => {
     ...
     * @param datasetresourcename The resource name of a dataset. For the default module, the resource name format is datasetName. Otherwise, the resource name format is module.datasetName.
     * @param args All other arguments.
     * @param args.filter A filter to apply to the dataset.
     * @return Array<Field>
     */
    public listFieldsForDataset = (datasetresourcename: string, args?: { filter?: string }): Promise<Array<Field>> => {
        const path_params = {
            datasetresourcename: datasetresourcename
        };
        const path = this.template`/catalog/v2beta1/datasets/${'datasetresourcename'}/fields`(path_params);
     ...
     * @param datasetid ID of a Dataset.
     * @param args All other arguments.
     * @param args.filter A filter to apply to a specified dataset. The filter must be a SPL predicate expression.
     * @return Array<Field>
     */
    public listFieldsForDatasetById = (datasetid: string, args?: { filter?: string }): Promise<Array<Field>> => {
        const path_params = {
            datasetid: datasetid
        };
        const path = this.template`/catalog/v2beta1/datasets/${'datasetid'}/fields`(path_params);
     ...
     * @param args All other arguments.
     * @param args.filter A filter to apply to the complete set of relationships.
     * @return Array<Relationship>
     */
    public listRelationships = (args?: { filter?: string }): Promise<Array<Relationship>> => {
        const path = `/catalog/v2beta1/relationships`;
        return this.client.get(CATALOG_SERVICE_CLUSTER, this.client.buildPath('', path.split('/').slice(1)), { query: args })
     ...
     * @param args All other arguments.
     * @param args.filter A query filter to apply to the complete set of rules.
     * @return Array<Rule>
     */
    public listRules = (args?: { filter?: string }): Promise<Array<Rule>> => {
        const path = `/catalog/v2beta1/rules`;
        return this.client.get(CATALOG_SERVICE_CLUSTER, this.client.buildPath('', path.split('/').slice(1)), { query: args })
     ...
     * @param workflowid ID of a workflow.
     * @param args All other arguments.
     * @param args.filter A filter to apply to the workflow builds. Must be a SPL predicate expression.
     * @return Array<WorkflowBuild>
     */
    public listWorkflowBuilds = (workflowid: string, args?: { filter?: string }): Promise<Array<WorkflowBuild>> => {
        const path_params = {
            workflowid: workflowid
        };
        const path = this.template`/catalog/v2beta1/workflows/${'workflowid'}/builds`(path_params);
     ...
     * @param workflowbuildid ID of a workflow build.
     * @param args All other arguments.
     * @param args.filter A filter to apply to the workflow runs for specified workflow build ID. Must be an SPL predicate expression.
     * @return Array<WorkflowRun>
     */
    public listWorkflowRuns = (workflowid: string, workflowbuildid: string, args?: { filter?: string }): Promise<Array<WorkflowRun>> => {
        const path_params = {
            workflowid: workflowid,
            workflowbuildid: workflowbuildid
        };
     ...
     * @param args All other arguments.
     * @param args.filter A filter to apply to the workflows. Must be a SPL predicate expression.
     * @return Array<Workflow>
     */
    public listWorkflows = (args?: { filter?: string }): Promise<Array<Workflow>> => {
        const path = `/catalog/v2beta1/workflows`;
        return this.client.get(CATALOG_SERVICE_CLUSTER, this.client.buildPath('', path.split('/').slice(1)), { query: args })
     ...
     */
    public updateDashboardById = (dashboardid: string, dashboardPATCH: DashboardPATCH): Promise<object> => {
        const path_params = {
            dashboardid: dashboardid
        };
        const path = this.template`/catalog/v2beta1/dashboards/${'dashboardid'}`(path_params);
