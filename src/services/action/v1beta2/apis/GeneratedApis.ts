...
export class GeneratedActionService extends BaseApiService {
    ...
    public createAction = (action: Action): Promise<Action> => {
        ...
        return this.client.post(ACTION_SERVICE_CLUSTER, this.client.buildPath('', path.split('/').slice(1)), action)
    ...
    public deleteAction = (actionName: string): Promise<object> => {
        ...
        return this.client.delete(ACTION_SERVICE_CLUSTER, this.client.buildPath('', path.split('/').slice(1)))
    ...
    public getAction = (actionName: string): Promise<Action> => {
        ...
        const path = this.template`/action/v1beta2/actions/${'action_name'}`(path_params);
        return this.client.get(ACTION_SERVICE_CLUSTER, this.client.buildPath('', path.split('/').slice(1)))
            .then(response => response.body as Action);
    }
    /**
     ...
     * @return ActionResult
     */
    public getActionStatus = (actionName: string, statusId: string): Promise<ActionResult> => {
        const path_params = {
            action_name: actionName,
            status_id: statusId
        };
     ...
     */
    public getActionStatusDetails = (actionName: string, statusId: string): Promise<Array<ActionResultEmailDetail>> => {
        const path_params = {
            action_name: actionName,
            status_id: statusId
        };
     ...
     */
    public getPublicWebhookKeys = (): Promise<Array<PublicWebhookKey>> => {
     ...
     * @return Array<Action>
     */
    public listActions = (): Promise<Array<Action>> => {
        const path = `/action/v1beta2/actions`;
        return this.client.get(ACTION_SERVICE_CLUSTER, this.client.buildPath('', path.split('/').slice(1)))
     ...
     */
    public triggerAction = (actionName: string, triggerEvent: TriggerEvent): Promise<object> => {
        const path_params = {
            action_name: actionName
        };
        const path = this.template`/action/v1beta2/actions/${'action_name'}`(path_params);
        return this.client.post(ACTION_SERVICE_CLUSTER, this.client.buildPath('', path.split('/').slice(1)), triggerEvent)
            .then(response => response.body as object);
    }
    /**
     ...
     * @return Action
     */
    public updateAction = (actionName: string, actionMutable: ActionMutable): Promise<Action> => {
        const path_params = {
            action_name: actionName
        };
        const path = this.template`/action/v1beta2/actions/${'action_name'}`(path_params);
        return this.client.patch(ACTION_SERVICE_CLUSTER, this.client.buildPath('', path.split('/').slice(1)), actionMutable)
            .then(response => response.body as Action);
    }
}
