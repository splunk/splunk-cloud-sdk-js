...
export function TriggerEventKindFromJSON(json: any): TriggerEventKind {
    return json as TriggerEventKind;
}

export function TriggerEventKindToJSON(value?: TriggerEventKind): any {
    return value as any;
}
