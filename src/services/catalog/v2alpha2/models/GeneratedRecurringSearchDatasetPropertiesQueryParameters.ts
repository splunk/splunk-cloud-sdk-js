 ...
 * @export
 * @interface RecurringSearchDatasetPropertiesQueryParameters
 */
export interface RecurringSearchDatasetPropertiesQueryParameters {
    /**
     * The earliest time, in relative format, to retrieve events.
     * @type {string}
     * @memberof RecurringSearchDatasetPropertiesQueryParameters
     */
    earliest?: string;
