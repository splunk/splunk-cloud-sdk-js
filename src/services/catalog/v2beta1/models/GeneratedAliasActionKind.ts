 ...
 * @export
 */
export enum AliasActionKind {
    ALIAS = 'ALIAS'
}

export function AliasActionKindFromJSON(json: any): AliasActionKind {
    return json as AliasActionKind;
}

export function AliasActionKindToJSON(value?: AliasActionKind): any {
    return value as any;
}
