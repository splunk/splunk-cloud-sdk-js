 ...
 * @export
 */
export enum CatalogDatasetKind {
    Catalog = 'catalog'
}

export function CatalogDatasetKindFromJSON(json: any): CatalogDatasetKind {
    return json as CatalogDatasetKind;
}

export function CatalogDatasetKindToJSON(value?: CatalogDatasetKind): any {
    return value as any;
}
