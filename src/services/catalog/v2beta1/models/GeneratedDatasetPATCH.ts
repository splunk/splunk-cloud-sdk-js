 ...
 * @export
 */
export type DatasetPATCH = FederatedDatasetPATCH | ImportDatasetPATCH | IndexDatasetPATCH | KVCollectionDatasetPATCH | LookupDatasetPATCH | MetricDatasetPATCH | ViewDatasetPATCH;
