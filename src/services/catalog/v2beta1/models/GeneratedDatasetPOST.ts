 ...
 * @export
 */
export type DatasetPOST = FederatedDatasetPOST | ImportDatasetPOST | IndexDatasetPOST | KVCollectionDatasetPOST | LookupDatasetPOST | MetricDatasetPOST | ViewDatasetPOST;
