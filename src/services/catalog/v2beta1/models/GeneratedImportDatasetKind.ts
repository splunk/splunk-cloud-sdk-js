 ...
 * @export
 */
export enum ImportDatasetKind {
    Import = 'import'
}

export function ImportDatasetKindFromJSON(json: any): ImportDatasetKind {
    return json as ImportDatasetKind;
}

export function ImportDatasetKindToJSON(value?: ImportDatasetKind): any {
    return value as any;
}
