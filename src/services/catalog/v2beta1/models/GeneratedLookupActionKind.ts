 ...
 * @export
 */
export enum LookupActionKind {
    LOOKUP = 'LOOKUP'
}

export function LookupActionKindFromJSON(json: any): LookupActionKind {
    return json as LookupActionKind;
}

export function LookupActionKindToJSON(value?: LookupActionKind): any {
    return value as any;
}
