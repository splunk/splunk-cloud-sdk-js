 ...
 * @export
 */
export enum LookupDatasetKind {
    Lookup = 'lookup'
}

export function LookupDatasetKindFromJSON(json: any): LookupDatasetKind {
    return json as LookupDatasetKind;
}

export function LookupDatasetKindToJSON(value?: LookupDatasetKind): any {
    return value as any;
}
