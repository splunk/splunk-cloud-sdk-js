 ...
 * @export
 */
export enum MetricDatasetKind {
    Metric = 'metric'
}

export function MetricDatasetKindFromJSON(json: any): MetricDatasetKind {
    return json as MetricDatasetKind;
}

export function MetricDatasetKindToJSON(value?: MetricDatasetKind): any {
    return value as any;
}
