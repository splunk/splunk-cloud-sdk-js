 ...
 * @export
 */
export enum Splv1sinkDatasetKind {
    Splv1sink = 'splv1sink'
}

export function Splv1sinkDatasetKindFromJSON(json: any): Splv1sinkDatasetKind {
    return json as Splv1sinkDatasetKind;
}

export function Splv1sinkDatasetKindToJSON(value?: Splv1sinkDatasetKind): any {
    return value as any;
}
