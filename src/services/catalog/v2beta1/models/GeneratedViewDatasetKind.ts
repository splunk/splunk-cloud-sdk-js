 ...
 * @export
 */
export enum ViewDatasetKind {
    View = 'view'
}

export function ViewDatasetKindFromJSON(json: any): ViewDatasetKind {
    return json as ViewDatasetKind;
}

export function ViewDatasetKindToJSON(value?: ViewDatasetKind): any {
    return value as any;
}
