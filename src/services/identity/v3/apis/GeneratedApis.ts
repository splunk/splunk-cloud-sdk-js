...
export const IDENTITY_SERVICE_PREFIX: string = '/identity/v3';
...
export class GeneratedIdentityService extends BaseApiService {
    ...
    public addGroupMember = (group: string, addGroupMemberBody: AddGroupMemberBody, args?: object, requestStatusCallback?: (requestStatus: RequestStatus) => void): Promise<GroupMember> => {
        ...
        const path = this.template`/identity/v3/groups/${'group'}/members`(path_params);
    ...
    public addGroupRole = (group: string, addGroupRoleBody: AddGroupRoleBody, args?: object, requestStatusCallback?: (requestStatus: RequestStatus) => void): Promise<GroupRole> => {
        ...
        const path = this.template`/identity/v3/groups/${'group'}/roles`(path_params);
    ...
    public addMember = (addMemberBody: AddMemberBody, args?: object, requestStatusCallback?: (requestStatus: RequestStatus) => void): Promise<Member> => {
        const path = `/identity/v3/members`;
    ...
    public addPrincipalPublicKey = (principal: string, eCJwk: ECJwk, args?: object, requestStatusCallback?: (requestStatus: RequestStatus) => void): Promise<PrincipalPublicKey> => {
        ...
        const path = this.template`/system/identity/v3/principals/${'principal'}/keys`(path_params);
    ...
    public addRolePermission = (role: string, addRolePermissionBody: AddRolePermissionBody, args?: object, requestStatusCallback?: (requestStatus: RequestStatus) => void): Promise<RolePermission> => {
        ...
        const path = this.template`/identity/v3/roles/${'role'}/permissions`(path_params);
    ...
    public createIdentityProvider = (identityProviderConfigBody: IdentityProviderConfigBody, args?: object, requestStatusCallback?: (requestStatus: RequestStatus) => void): Promise<IdentityProviderBody> => {
        const path = `/identity/v3/identityproviders`;
    ...
    public createPrincipal = (createPrincipalBody: CreatePrincipalBody, args?: { inviteID?: string, [key: string]: any }, requestStatusCallback?: (requestStatus: RequestStatus) => void): Promise<Principal> => {
        const path = `/system/identity/v3/principals`;
    ...
    public createSamlClient = (createSamlClientBody: CreateSamlClientBody, args?: object, requestStatusCallback?: (requestStatus: RequestStatus) => void): Promise<SamlClient> => {
        const path = `/identity/v3/clients/saml`;
    ...
    public deleteGroup = (group: string, args?: object, requestStatusCallback?: (requestStatus: RequestStatus) => void): Promise<object> => {
        ...
        const path = this.template`/identity/v3/groups/${'group'}`(path_params);
    ...
    public deleteIdentityProvider = (idp: string, args?: object, requestStatusCallback?: (requestStatus: RequestStatus) => void): Promise<object> => {
        ...
        const path = this.template`/identity/v3/identityproviders/${'idp'}`(path_params);
        return this.client.delete(IDENTITY_SERVICE_CLUSTER, this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback:  requestStatusCallback})
            .then(response => response.body as object);
    }
    /**
    ...
    public deletePrincipalPublicKey = (principal: string, keyId: string, args?: object, requestStatusCallback?: (requestStatus: RequestStatus) => void): Promise<object> => {
        ...
        const path = this.template`/system/identity/v3/principals/${'principal'}/keys/${'keyId'}`(path_params);
        return this.client.delete(IDENTITY_SERVICE_CLUSTER, this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback:  requestStatusCallback})
            .then(response => response.body as object);
    }
    /**
    ...
    public deleteRole = (role: string, args?: object, requestStatusCallback?: (requestStatus: RequestStatus) => void): Promise<object> => {
        ...
        const path = this.template`/identity/v3/roles/${'role'}`(path_params);
        return this.client.delete(IDENTITY_SERVICE_CLUSTER, this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback:  requestStatusCallback})
            .then(response => response.body as object);
    }
    /**
    ...
    public deleteSamlClient = (samlClient: string, args?: object, requestStatusCallback?: (requestStatus: RequestStatus) => void): Promise<object> => {
        ...
        const path = this.template`/identity/v3/clients/saml/${'samlClient'}`(path_params);
        return this.client.delete(IDENTITY_SERVICE_CLUSTER, this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback:  requestStatusCallback})
            .then(response => response.body as object);
    }
    /**
     ...
     */
    public getEntitlements = (entitlementClientId: string, args?: object, requestStatusCallback?: (requestStatus: RequestStatus) => void): Promise<EntitlementList> => {
        const path_params = {
            entitlementClientId: entitlementClientId
        };
        const path = this.template`/identity/v3/commerce/subscribed-apps/${'entitlementClientId'}/entitlements`(path_params);
        return this.client.get(IDENTITY_SERVICE_CLUSTER, this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback:  requestStatusCallback})
            .then(response => response.body as EntitlementList);
    }
    /**
    ...
    public getGroupMember = (group: string, member: string, args?: object, requestStatusCallback?: (requestStatus: RequestStatus) => void): Promise<GroupMember> => {
        ...
        const path = this.template`/identity/v3/groups/${'group'}/members/${'member'}`(path_params);
        return this.client.get(IDENTITY_SERVICE_CLUSTER, this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback:  requestStatusCallback})
            .then(response => response.body as GroupMember);
    }
    /**
    ...
    public getGroupRole = (group: string, role: string, args?: object, requestStatusCallback?: (requestStatus: RequestStatus) => void): Promise<GroupRole> => {
        ...
        const path = this.template`/identity/v3/groups/${'group'}/roles/${'role'}`(path_params);
        return this.client.get(IDENTITY_SERVICE_CLUSTER, this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback:  requestStatusCallback})
            .then(response => response.body as GroupRole);
    }
    /**
    ...
    public getMember = (member: string, args?: object, requestStatusCallback?: (requestStatus: RequestStatus) => void): Promise<Member> => {
        ...
        const path = this.template`/identity/v3/members/${'member'}`(path_params);
        return this.client.get(IDENTITY_SERVICE_CLUSTER, this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback:  requestStatusCallback})
            .then(response => response.body as Member);
    }
    /**
    ...
    public getPrincipal = (principal: string, args?: object, requestStatusCallback?: (requestStatus: RequestStatus) => void): Promise<Principal> => {
        ...
        const path = this.template`/system/identity/v3/principals/${'principal'}`(path_params);
        return this.client.get(IDENTITY_SERVICE_CLUSTER, this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback:  requestStatusCallback})
            .then(response => response.body as Principal);
    }
    /**
    ...
    public getRolePermission = (role: string, permission: string, args?: object, requestStatusCallback?: (requestStatus: RequestStatus) => void): Promise<RolePermission> => {
        ...
        const path = this.template`/identity/v3/roles/${'role'}/permissions/${'permission'}`(path_params);
        return this.client.get(IDENTITY_SERVICE_CLUSTER, this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback:  requestStatusCallback})
            .then(response => response.body as RolePermission);
    }
    /**
    ...
    public listMemberGroups = (member: string, args?: { orderby?: string, pageSize?: number, pageToken?: string, [key: string]: any }, requestStatusCallback?: (requestStatus: RequestStatus) => void): Promise<GroupList> => {
        ...
        const path = this.template`/identity/v3/members/${'member'}/groups`(path_params);
        return this.client.get(IDENTITY_SERVICE_CLUSTER, this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback:  requestStatusCallback})
            .then(response => response.body as GroupList);
    }
    /**
    ...
    public listMemberPermissions = (member: string, args?: { orderby?: string, pageSize?: number, pageToken?: string, scopeFilter?: string, [key: string]: any }, requestStatusCallback?: (requestStatus: RequestStatus) => void): Promise<PermissionList> => {
        ...
        const path = this.template`/identity/v3/members/${'member'}/permissions`(path_params);
        return this.client.get(IDENTITY_SERVICE_CLUSTER, this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback:  requestStatusCallback})
    ...
    public listMemberRoles = (member: string, args?: { orderby?: string, pageSize?: number, pageToken?: string, [key: string]: any }, requestStatusCallback?: (requestStatus: RequestStatus) => void): Promise<RoleList> => {
        ...
        const path = this.template`/identity/v3/members/${'member'}/roles`(path_params);
        return this.client.get(IDENTITY_SERVICE_CLUSTER, this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback:  requestStatusCallback})
    ...
    public listRoleGroups = (role: string, args?: { orderby?: string, pageSize?: number, pageToken?: string, [key: string]: any }, requestStatusCallback?: (requestStatus: RequestStatus) => void): Promise<GroupList> => {
        ...
        const path = this.template`/identity/v3/roles/${'role'}/groups`(path_params);
        return this.client.get(IDENTITY_SERVICE_CLUSTER, this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback:  requestStatusCallback})
            .then(response => response.body as GroupList);
    }
    /**
    ...
    public resetPassword = (resetPasswordBody: ResetPasswordBody, args?: object, requestStatusCallback?: (requestStatus: RequestStatus) => void): Promise<object> => {
        const path = `/system/identity/v3/reset-password`;
    ...
    public revokePrincipalAuthTokens = (principal: string, args?: object, requestStatusCallback?: (requestStatus: RequestStatus) => void): Promise<object> => {
        ...
        const path = this.template`/system/identity/v3/principals/${'principal'}/revoke`(path_params);
     ...
     * @return EntitlementList
     */
    public updateEntitlements = (entitlementClientId: string, setEntitlement: Array<SetEntitlement>, args?: object, requestStatusCallback?: (requestStatus: RequestStatus) => void): Promise<EntitlementList> => {
        const path_params = {
            entitlementClientId: entitlementClientId
        };
        const path = this.template`/identity/v3/commerce/subscribed-apps/${'entitlementClientId'}/entitlements`(path_params);
        return this.client.put(IDENTITY_SERVICE_CLUSTER, this.client.buildPath('', path.split('/').slice(1)), setEntitlement, { query: args, statusCallback:  requestStatusCallback})
            .then(response => response.body as EntitlementList);
    }
    /**
     ...
     * @return Group
     */
    public updateGroup = (group: string, updateGroupBody: UpdateGroupBody, args?: object, requestStatusCallback?: (requestStatus: RequestStatus) => void): Promise<Group> => {
        const path_params = {
            group: group
        };
        const path = this.template`/identity/v3/groups/${'group'}`(path_params);
        return this.client.patch(IDENTITY_SERVICE_CLUSTER, this.client.buildPath('', path.split('/').slice(1)), updateGroupBody, { query: args, statusCallback:  requestStatusCallback})
            .then(response => response.body as Group);
    }
    /**
    ...
    public updatePassword = (principal: string, updatePasswordBody: UpdatePasswordBody, args?: object, requestStatusCallback?: (requestStatus: RequestStatus) => void): Promise<object> => {
        ...
        const path = this.template`/system/identity/v3/principals/${'principal'}/password`(path_params);
     ...
     * @return Role
     */
    public updateRole = (role: string, updateRoleBody: UpdateRoleBody, args?: object, requestStatusCallback?: (requestStatus: RequestStatus) => void): Promise<Role> => {
        const path_params = {
            role: role
        };
        const path = this.template`/identity/v3/roles/${'role'}`(path_params);
        return this.client.patch(IDENTITY_SERVICE_CLUSTER, this.client.buildPath('', path.split('/').slice(1)), updateRoleBody, { query: args, statusCallback:  requestStatusCallback})
            .then(response => response.body as Role);
    }
    /**
    ...
    public validateToken = (args?: { include?: Array<string>, [key: string]: any }, requestStatusCallback?: (requestStatus: RequestStatus) => void): Promise<ValidateInfo> => {
        const path = `/identity/v3/validate`;
        return this.client.get(IDENTITY_SERVICE_CLUSTER, this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback:  requestStatusCallback})
