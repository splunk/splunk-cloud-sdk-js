 ...
 * @export
 */
export enum FederatedDatasetKind {
    Federated = 'federated'
}

export function FederatedDatasetKindFromJSON(json: any): FederatedDatasetKind {
    return json as FederatedDatasetKind;
}

export function FederatedDatasetKindToJSON(value?: FederatedDatasetKind): any {
    return value as any;
}
