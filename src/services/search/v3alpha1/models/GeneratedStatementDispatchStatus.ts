...
/**
 * The dispatch status of a search single-statement.
 * @export
 * @interface StatementDispatchStatus
 */
export interface StatementDispatchStatus {
    /**
     * The single export statement search.
     * @type {string}
     * @memberof StatementDispatchStatus
     */
    readonly query?: string;

    /**
     * The search ID for the statement.
     * @type {string}
     * @memberof StatementDispatchStatus
     */
    readonly sid?: string;
