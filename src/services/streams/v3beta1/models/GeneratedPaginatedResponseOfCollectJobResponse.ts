 ...
 *
 * @export
 * @interface PaginatedResponseOfCollectJobResponse
 */
export interface PaginatedResponseOfCollectJobResponse {
    /**
     * 
     * @type {Array<CollectJobResponse>}
     * @memberof PaginatedResponseOfCollectJobResponse
     */
    items?: Array<CollectJobResponse>;
