 ...
 *
 * @export
 * @interface PaginatedResponseOfRulesKind
 */
export interface PaginatedResponseOfRulesKind {
    /**
     * 
     * @type {Array<RulesKind>}
     * @memberof PaginatedResponseOfRulesKind
     */
    items?: Array<RulesKind>;
