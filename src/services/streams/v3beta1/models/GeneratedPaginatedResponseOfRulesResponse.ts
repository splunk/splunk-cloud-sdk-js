 ...
 *
 * @export
 * @interface PaginatedResponseOfRulesResponse
 */
export interface PaginatedResponseOfRulesResponse {
    /**
     * 
     * @type {Array<RulesResponse>}
     * @memberof PaginatedResponseOfRulesResponse
     */
    items?: Array<RulesResponse>;
