 ...
 *
 * @export
 * @interface RulesPackageSourcetypes
 */
export interface RulesPackageSourcetypes {
    /**
     * List of actions for the sourcetype
     * @type {Array<RulesPackageActions>}
     * @memberof RulesPackageSourcetypes
     */
    actions: Array<RulesPackageActions>;
