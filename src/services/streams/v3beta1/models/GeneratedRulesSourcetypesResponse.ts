 ...
 *
 * @export
 * @interface RulesSourcetypesResponse
 */
export interface RulesSourcetypesResponse {
    /**
     * 
     * @type {Array<RulesActionsResponse>}
     * @memberof RulesSourcetypesResponse
     */
    actions?: Array<RulesActionsResponse>;
