...
describe('integration tests for Ingest Endpoints', () => {
    ...
    const successResponse: ingestModels.HTTPResponse = { code: 'SUCCESS', message: 'The event was sent successfully.' };
    const event1: ingestModels.Event = { sourcetype: 'splunkd', source: 'mysource', timestamp: 1536174774569, attributes: { fieldkey1: 'fieldval1', fieldkey2: 'fieldkey2' }, host: 'myhost', body: { body: 'INFO  ServerConfig - Will generate GUID, as none found on this server.' } };
    const event2: ingestModels.Event = { sourcetype: 'splunkd', source: 'mysource', timestamp: 1536174774570, attributes: { fieldkey1: 'fieldval1', fieldkey2: 'fieldkey2' }, host: 'myhost', body: { body: 'INFO  ServerConfig - My newly generated GUID is 6F386D83-ADB2-4BAB-A7AA-634B0BEA2C6A' } };
    const event3: ingestModels.Event = { sourcetype: 'splunkd', source: 'mysource', timestamp: 1536174774571, attributes: { fieldkey1: 'fieldval1', fieldkey2: 'fieldkey2' }, host: 'myhost', body: { body: 'INFO  ServerConfig - My server name is "9765f1bebdb4".' } };
    const event4: ingestModels.Event = { sourcetype: 'splunkd', source: 'mysource', timestamp: 1536174774572, attributes: { fieldkey1: 'fieldval1', fieldkey2: 'fieldkey2' }, host: 'myhost', body: { body: 'INFO  ServerConfig - My server name is "9765f1bebdb5".' } };
    const event5: ingestModels.Event = { sourcetype: 'splunkd', source: 'mysource', timestamp: 1536174774573, attributes: { fieldkey1: 'fieldval1', fieldkey2: 'fieldkey2' }, host: 'myhost', body: { body: 'INFO  ServerConfig - My server name is "9765f1bebdb6".' } };
    const event6: ingestModels.Event = { sourcetype: 'splunkd', source: 'mysource', timestamp: 1536174774574, attributes: { fieldkey1: 'fieldval1', fieldkey2: 'fieldkey2' }, host: 'myhost', body: { body: 'INFO  ServerConfig - My server name is "9765f1bebdb7".' } };
    const event7: ingestModels.Event = { sourcetype: 'splunkd', source: 'mysource', timestamp: 1536174774575, attributes: { fieldkey1: 'fieldval1', fieldkey2: 'fieldkey2' }, host: 'myhost', body: { body: 'INFO  ServerConfig - My server name is "9765f1bebdb8".' } };
    const event8: ingestModels.Event = { sourcetype: 'splunkd', source: 'mysource', timestamp: 1536174774576, attributes: { fieldkey1: 'fieldval1', fieldkey2: 'fieldkey2' }, host: 'myhost', body: { body: 'INFO  ServerConfig - My server name is "9765f1bebdb9".' } };
    const event9: ingestModels.Event = { sourcetype: 'splunkd', source: 'mysource', timestamp: 1536174774577, attributes: { fieldkey1: 'fieldval1', fieldkey2: 'fieldkey2' }, host: 'myhost', body: { body: 'INFO  ServerConfig - My server name is "9765f1bebdc0".' } };
    const event10: ingestModels.Event = { sourcetype: 'splunkd', source: 'mysource', timestamp: 1536174774578, attributes: { fieldkey1: 'fieldval1', fieldkey2: 'fieldkey2' }, host: 'myhost', body: { body: 'INFO  ServerConfig - My server name is "9765f1bebdc1".' } };
    ...
    describe('Events Endpoint', () => {
        ...
        describe('Post events', () => {
            it('should return a successful response', () => {
                ...
                return splunk.ingest.postEvents(events).then((response: ingestModels.HTTPResponse) => {
        ...
        describe('Post batch 10 events', () => {
            ...
            it('should create 10 batched events and send them when event10 is added', () => {
                const events: ingestModels.Event[] = [event1, event2, event3, event4, event5, event6, event7, event8, event9, event10];
                ...
                try {
                    for (const e of events) {
                        ...
                        const addPromise = eb.add(event) as Promise<ingestModels.HTTPResponse|{}>;
        ...
        describe('Post batch 1 events', () => {
            it('should create 1 batch event and wait for timer to send it', () => {
                ...
                try {
                    const addPromise = eb.add(event1) as Promise<ingestModels.HTTPResponse|{}>;
                    addPromise.then(response => {
                        console.log(response);
                    }).catch(err => console.log(err));
                } finally {
    ...
    describe('Metrics Endpoint', () => {
        ...
        const metrics: ingestModels.Metric[] = [
            {
        ...
        const metricEvent1: ingestModels.MetricEvent = {
            attributes: {
                defaultDimensions: {},
                defaultType: 'g',
                defaultUnit: 'MB'
