...
describe('Identity Endpoints', () => {
    ...
    describe('Create a new member', () => {
        it('should return a new member', () => {
            ...
            return splunk.identity.addMember(memberName).then(data => {
    ...
    describe('Get a member', () => {
        it('should return a member', () => {
            return splunk.identity.getMember('mem1').then(data => {
                assert.equal(data.tenant,'TEST_TENANT', 'tenant should be TEST_TENANT');
                assert.equal(data.name,'mem1', 'member should be mem1');
    ...
    describe('Get all members', () => {
        it('should return a list of members', () => {
            return splunk.identity.getMembers().then(data => {
    ...
    describe('Create a new role', () => {
        it('should return a new role', () => {
            ...
            return splunk.identity.createRole(roleInput).then(data => {
                assert.equal(data.tenant,'TEST_TENANT', 'tenant should be TEST_TENANT');
    ...
    describe('Get a list of roles for a tenant', () => {
        it('should return a list of roles', () => splunk.identity.getRoles().then(data => {
            assert.typeOf(data, 'Array', 'response should be an array');
    ...
    describe('Get a role details', () => {
        it('should return the details for a role', () => splunk.identity.getRole('role2').then(data => {
            assert.equal(data.tenant, 'TEST_TENANT', 'tenant should be TEST_TENANT');
    ...
    describe('Delete a role from a tenant', () => {
        it('should return no response body', () => {
            return splunk.identity.deleteRole('roles.sdk-test').then(response => {
                assert(!response);
            });
        });
    });
    ...
    describe('Get a role permissions', () => {
        it('should return a list of roles', () => splunk.identity.getRolePermissions('role2').then(data => {
            assert.typeOf(data, 'Array', 'response should be an array');
    ...
    describe('Get a role permission details', () => {
        it('should return a list of roles', () => splunk.identity.getRolePermission('role2', 'perm2').then(data => {
            assert.equal(data.tenant, 'TEST_TENANT', 'tenant should be TEST_TENANT');
    ...
    describe('Delete a permission from a role', () => {
        it('should return no response body', () => {
            return splunk.identity.removeRolePermission('roles.sdk-test', 'TEST_TENANT:%252A:kvstore.%252A').then(response => {
                assert(!response);
            });
        });
    });
    ...
    describe('Create a new group', () => {
        it('should return no response body', () => {
            ...
            return splunk.identity.createGroup(postBody).then(data => {
                assert.equal(data.tenant, 'TEST_TENANT', 'tenant should be TEST_TENANT');
    ...
    describe('Delete a group', () => {
        it('should return no response body', () => {
            return splunk.identity.deleteGroup('sdk-group').then(response => {
                assert(!response);
            });
        });
    });
    ...
    describe('Get details for a group', () => {
        it('should return group details', () => splunk.identity.getGroup('grp1').then(data => {
            assert.equal(data.tenant, 'TEST_TENANT', 'tenant should be TEST_TENANT');
    ...
    describe('Get group roles for a tenant', () => {
        it('should return a list of roles', () => splunk.identity.getGroupRoles('grp1').then(data => {
            assert.typeOf(data, 'Array', 'response should be an array');
            assert.equal(data[0], 'role1', 'role1 should be in the list');
            assert.equal(data[1], 'role2', 'role2 should be in the list');
        }));
    ...
    describe('Remove a role from a group', () => {
        it('should return no response body', () => {
            return splunk.identity.removeGroupRole('sdk-group', 'roles.sdk-test').then(response => {
                assert(!response);
            });
        });
    });
    ...
    describe('Create a new group member', () => {
        it('should return no response body', () => {
            ...
            return splunk.identity.addGroupMember('sdk-group', postBody).then(data => {
                assert.equal(data.tenant, 'TEST_TENANT', 'tenant should be TEST_TENANT');
    ...
    describe('Get details for a group member', () => {
        it('should return group member details', () => splunk.identity.getGroupMember('grp1', 'mem1').then(data => {
            assert.equal(data.tenant, 'TEST_TENANT', 'tenant should be TEST_TENANT');
    ...
    describe('Get group members for a tenant', () => {
        it('should return a list of members', () => splunk.identity.getGroupMembers('grp1').then(data => {
            assert.typeOf(data, 'Array', 'response should be an array');
    ...
    describe('Get member groups for a tenant', () => {
        it('should return a list of members', () => splunk.identity.getMemberGroups('mem1').then(data => {
            assert.typeOf(data, 'Array', 'response should be an array');
    ...
    describe('Delete a member from a group', () => {
        it('should return no response body', () => {
            return splunk.identity.removeGroupMember('sdk-group', 'sdk-int-test@splunk.com').then(response => {
                assert(!response);
            });
        });
    });
